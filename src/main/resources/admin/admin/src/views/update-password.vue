<template>
	<div :style='{"width":"calc(100% - 60px)","padding":"30px","boxShadow":"0 4px 8px #1C5717","margin":"20px 0 20px 40px","background":"#fff"}'>
		<el-form
			:style='{"padding":"0 30% 0 15%","borderColor":"#eee","borderStyle":"solid","borderWidth":"0px 0 0"}'
		...
		>
			...
			<el-form-item :style='{"padding":"0","margin":"20px 0 0"}'>
				<el-button class="btn3" :style='{"border":"0px solid #ccc","cursor":"pointer","padding":"0 10px","margin":"0 10px 0 0","color":"#fff","borderRadius":"0","background":"#969C2D","width":"auto","fontSize":"16px","minWidth":"110px","height":"40px"}' type="primary" @click="onUpdateHandler">
		...
		async onUpdateHandler() {
			this.$refs["ruleForm"].validate(async valid => {
				if (valid) {
					...
					if (this.$storage.get("sessionTable") == 'cangguan') {
					}
