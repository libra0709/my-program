	...
	<div class="addEdit-block">
		...
		>
			<template >
				...
				<el-form-item v-else class="input" label="车辆型号" prop="cheliangxinghao" >
					<el-input v-model="ruleForm.cheliangxinghao" placeholder="车辆型号" readonly></el-input>
				</el-form-item>
				<el-form-item class="select" v-if="type!='info'"  label="载重类型" prop="zaizhongleixing" >
					<el-select :disabled="ro.zaizhongleixing" v-model="ruleForm.zaizhongleixing" placeholder="请选择载重类型" >
						<el-option
							v-for="(item,index) in zaizhongleixingOptions"
							v-bind:key="index"
							:label="item"
							:value="item">
						</el-option>
				...
				<el-form-item v-else class="input" label="载重类型" prop="zaizhongleixing" >
					<el-input v-model="ruleForm.zaizhongleixing"
						placeholder="载重类型" readonly></el-input>
				</el-form-item>
				...
				<el-form-item v-else class="input" label="车辆状态" prop="cheliangzhuangtai" >
			...
			<el-form-item class="textarea" v-if="type!='info'" label="车辆详情" prop="cheliangxiangqing" >
				<el-input
			...
			<el-form-item v-else-if="ruleForm.cheliangxiangqing" label="车辆详情" prop="cheliangxiangqing" >
				<span class="text">{{ruleForm.cheliangxiangqing}}</span>
			</el-form-item>
		...
		methods: {
			...
			init(id,type) {
				...
				if(this.type=='info'||this.type=='else'||this.type=='msg'){
					...
					this.ruleForm.cheliangzhuangtai = '待命'; 				}
				// 获取用户信息
				this.$http({
